        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex space-x-6">
              ...
              <Link to="/subjects" className="text-blue-600 hover:text-blue-800 font-semibold">📚 Subjects</Link>
              <Link to="/activities" className="text-blue-600 hover:text-blue-800 font-semibold">🎯 Activities</Link>
              <Link to="/dashboard" className="text-blue-600 hover:text-blue-800 font-semibold">📊 Dashboard</Link>
              <Link to="/certificates" className="text-blue-600 hover:text-blue-800 font-semibold">🏆 Certificates</Link>
              <Link to="/help" className="text-blue-600 hover:text-blue-800 font-semibold">❓ Help</Link>
            </div>
            <Link to="/cart">
